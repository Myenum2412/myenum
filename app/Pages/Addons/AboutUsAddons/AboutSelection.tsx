...
import myImage from "@/assets/about/about.png"; // Adjust the path based on your file structure
...
const Container: React.FC<ContainerProps> = ({ children, className = "" }) => {
  ...
  <FlipText className="text-4xl font-bold -tracking-widest text-white dark:text-white md:text-7xl md:leading-[5rem]">About Us</FlipText>
      ...
      <div className="content text-left">
        ...
        <p className="text-2xl mt-6">Under <LinkPreview url="https://bni-salem.in/en-IN/memberdetails?encryptedMemberId=VyR43%2BVKzpyWOMxTHyv88A%3D%3D&name=Amarnath+M+K" className="font-bold text-blue-500">Amarnath’s leadership</LinkPreview> Myenum has carved a niche in providing customized solutions that cater to both B2B and B2C markets. Understanding that no two businesses are the same, we work closely with our clients to create strategic, tailor-made websites that align with their brand, industry demands, and customer expectations.</p>
      ...
      <ul className="list-disc list-inside mt-2 text-2xl">
        ...
        <li><strong>Scalable Digital Solutions </strong> – Whether you’re a startup or an established business, we provide flexible, growth-ready solutions that evolve with your brand.</li>
      </ul>
      </div>
